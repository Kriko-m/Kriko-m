...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['save_tak_settings'])) {
        ...
        if (isset($settings['takken']) && isset($settings['takken'][$edit_tak])) {
            ...
            $settings['takken'][$edit_tak]['whatsapp_url'] = filter_input(INPUT_POST, 'whatsapp_url', FILTER_SANITIZE_URL) ?: '';
        ...
        <main>
            ...
            <div class="admin-panel <?php echo $active_tab === 'tak_settings' ? 'active' : ''; ?>" data-tab="tak_settings">
                ...
                <form action="admin.php" method="POST">
                    ...
                    <!-- WhatsApp -->
                    <div class="form-group">
                        <label class="form-label" for="whatsapp_url"><i class="fab fa-whatsapp" style="color: #25D366; margin-right: 6px;"></i>WhatsApp uitnodigingslink (optioneel):</label>
                        <input type="url" id="whatsapp_url" name="whatsapp_url" class="form-control" value="<?php echo htmlspecialchars($tak_info['whatsapp_url'] ?? ''); ?>" placeholder="https://chat.whatsapp.com/...">
                        <small style="color: var(--color-text-muted); font-size: 0.8rem;">Groepsuitnodigingslink vanuit WhatsApp → Groepsinfo → Uitnodigingslink</small>
                    </div>
