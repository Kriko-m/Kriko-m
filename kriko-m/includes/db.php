...
/*
 * BELANGRIJK — de databestanden staan BUITEN de webroot.
 * De app draait in .../kriko-m/ (dat is de webroot); de data-map zit één
 * niveau hoger (.../data/). Daardoor is ze fysiek onbereikbaar via eender
 * welke URL, ongeacht de webserver (Apache, Nginx of PHP dev-server).
 * Uploads (PDF's, foto's) blijven wél in de webroot, want die zijn publiek.
 */
