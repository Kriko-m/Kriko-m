...
<section class="section container">
    <div class="register-layout">
        ...
        <div>
            ...
            <!-- Step 2: Groepsadministratie -->
            <div class="step-card">
                <div class="step-number">2</div>
                <div class="step-body">
                    <h4>Inschrijven via de groepsadministratie</h4>
                    <p style="color: var(--color-text-dark); font-size: 0.95rem; margin-bottom: 10px;">
                        Officieel lid worden doe je via de <strong>groepsadministratie van Scouts &amp; Gidsen Vlaanderen</strong>. Vul het inschrijvingsformulier in — dit regelt meteen je verplichte scoutsverzekering.
                    </p>
                    <a href="https://groepsadmin.scoutsengidsenvlaanderen.be/groepsadmin/client/formulier.html#/lidworden?groep=O3108G"
                       target="_blank" rel="noopener"
                       class="btn btn-secondary" style="font-size: 0.9rem; padding: 8px 18px; margin-bottom: 14px; display: inline-flex; align-items: center; gap: 8px;">
                        <i class="fa-solid fa-arrow-up-right-from-square"></i> Inschrijvingsformulier invullen
                    </a>
                    <p style="color: var(--color-text-muted); font-size: 0.85rem; margin-bottom: 6px;">
                        Na betaling van het lidgeld ontvang je een <strong>lidnummer per e-mail</strong>. Daarmee maak je een persoonlijk account aan op de groepsadministratie en kan je voortaan zelf inloggen.
                    </p>
                    <p style="color: var(--color-text-muted); font-size: 0.85rem;">
                        <strong>Al lid?</strong> Log rechtstreeks in via
                        <a href="https://groepsadmin.scoutsengidsenvlaanderen.be/groepsadmin/client/" target="_blank" rel="noopener" style="color: var(--color-primary); font-weight: 600;">groepsadmin.scoutsengidsenvlaanderen.be</a>
                        en hernieuw je inschrijving daar.
                    </p>
                </div>
            </div>
            ...
            <div class="step-card">
                ...
                <div class="step-body">
                    ...
                    <p style="color: var(--color-text-dark); font-size: 0.95rem; margin-bottom: 8px;">
                        Na het invullen van het formulier schrijf je het lidgeld over. Zodra wij de betaling ontvangen, krijg je je <strong>lidnummer per e-mail</strong> — daarmee activeer je je account op de groepsadministratie. Het bedrag dekt €38 scoutsverzekering (rechtstreeks naar Scouts &amp; Gidsen Vlaanderen) en €12 voor onze lokale werking.
                    </p>
        ...
        <div>
            ...
            <div class="side-card" style="background-color: var(--color-primary-dark); color: var(--color-bg-white); border: none;">
                <h3 style="color: var(--color-accent-light); border-bottom: 1px dashed rgba(255,255,255,0.2);">Jaarlijks Lidgeld</h3>
                ...
                <div style="display: flex; flex-direction: column; gap: 14px; margin-bottom: 24px;">
                    <div style="display: flex; justify-content: space-between; align-items: center; background-color: rgba(255,255,255,0.1); border-radius: var(--border-radius-md); padding: 14px; border: 1px solid rgba(255,255,255,0.15);">
                        ...
                        <strong style="font-size: 1.5rem; color: var(--color-accent-light);">€<?php echo number_format($fee_1, 2, ',', ''); ?></strong>
                    </div>
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center; background-color: rgba(255,255,255,0.1); border-radius: var(--border-radius-md); padding: 14px; border: 1px solid rgba(255,255,255,0.15);">
                        ...
                        <strong style="font-size: 1.5rem; color: var(--color-accent-light);">€<?php echo number_format($fee_2, 2, ',', ''); ?></strong>
                    </div>
                </div>
                
                <p style="font-size: 0.8rem; opacity: 0.8; line-height: 1.4;">
                    * Heeft u recht op verminderd lidgeld of is de betaling financieel moeilijk? Contacteer gerust onze groepsleiding via <a href="mailto:<?php echo htmlspecialchars($contact_email); ?>" style="color: var(--color-accent-light); font-weight: 700; text-decoration: underline;"><?php echo htmlspecialchars($contact_email); ?></a>. Wij behandelen elke aanvraag strikt vertrouwelijk en zorgen dat elk kind kan meespelen!
                </p>
            </div>
