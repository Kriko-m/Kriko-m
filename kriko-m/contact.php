...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name) || empty($email) || empty($subject) || empty($message_text)) {
        ...
        $body = "<p><strong>Nieuw bericht via het contactformulier</strong></p>"
              . "<p><strong>Naam:</strong> " . htmlspecialchars($name) . "<br>"
              . "<strong>E-mail:</strong> " . htmlspecialchars($email) . "<br>"
              . "<strong>Onderwerp:</strong> " . htmlspecialchars($subject) . "</p>"
              . "<p><strong>Bericht:</strong><br>" . nl2br(htmlspecialchars($message_text)) . "</p>";
        // 'Reply-To' = de ouder, zodat de leiding rechtstreeks kan antwoorden.
        scouts_send_mail($contact_email, 'Contactformulier: ' . $subject, $body, $email);

        $success_message = 'Bedankt! Jouw bericht is verzonden naar de leiding. We reageren zo snel mogelijk.';
    }
}
