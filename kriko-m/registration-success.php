...
<section class="tak-hero algemeen">
    <div class="container">
        <span class="hero-eyebrow">Inschrijving Bevestigd</span>
    ...
    <div style="background-color: var(--color-bg-white); border-radius: var(--border-radius-lg); box-shadow: var(--shadow-lg); border: 1px solid var(--color-border); overflow: hidden; margin-top: -50px; position: relative; z-index: 10;">
        ...
        <div style="padding: 30px 40px;">
            ...
            <div style="background-color: var(--color-bg-linen); border: 2px dashed var(--color-border); border-radius: var(--border-radius-lg); padding: 30px; margin-bottom: 35px;">
                <h3 style="font-size: 1.2rem; color: var(--color-primary-dark); margin-top: 0; margin-bottom: 20px; border-bottom: 1px solid var(--color-border); padding-bottom: 10px;">
                    Betalingsopdracht
                </h3>
            ...
            <div style="background-color: hsla(29, 57%, 46%, 0.1); border-left: 4px solid var(--color-secondary); padding: 15px; border-radius: var(--border-radius-sm); margin-bottom: 35px; font-size: 0.85rem; color: var(--color-text-dark); line-height: 1.5;">
