    ...
    <div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
        ...
        {kampen.map(kamp => {
          ...
          return (
            <div key={kamp.id} style={{ background: '#fff', border: `1.5px solid ${kleur}55`, borderRadius: 14, padding: '16px 20px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: 12 }}>
              <div>
