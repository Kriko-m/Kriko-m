...
export default function LeidingPanel({
  ...
  const [view, setView] = useState<'main' | 'kampen' | 'echos' | 'kalender'>('main')
    ...
    <div className="portaal-dashboard-bg-wrapper">
      ...
      <div className="portaal-dashboard-card">
        ...
        {view === 'main' ? (
          <div>
            {/* Layout Grid */}
            <div style={{ display: 'grid', gridTemplateColumns: '1.8fr 1fr', gap: 24 }} className="portal-grid-layout">
