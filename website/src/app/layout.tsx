...
import { Outfit, Nunito, Bungee_Shade } from "next/font/google";
import "./globals.css";
...
const bungeeShade = Bungee_Shade({ subsets: ["latin"], weight: ["400"], variable: "--font-londrina", display: "swap" });
...
export default function RootLayout({
  ...
  return (
    <html lang="nl" className={`${outfit.variable} ${nunito.variable} ${bungeeShade.variable}`} suppressHydrationWarning data-scroll-behavior="smooth">
      <head>
